-- Fix energy initialization to 100 for newly hatched pets
-- The database schema defines energy DEFAULT 100, but the hatch_pet RPC was explicitly setting it to 50
...
BEGIN
  ...
  -- FIXED: Changed energy from 50 to 100 to match schema DEFAULT
  UPDATE public.pets
  SET
    ...
    comfort = 50,
    rest = 50,
    energy = 100,  -- CHANGED FROM 50 TO 100
    bond = 0,
    neglect_hours = 0,
    ran_away = false,
    runaway_at = NULL,
