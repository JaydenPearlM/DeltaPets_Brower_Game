-- Fix hatch_pet RPC to match backend/server/src/routes/routePets/routePets.ts
-- Uses the current pets table care columns only:
-- clean, happy, ran_away, last_care_decay_at
